...
#define PSAMMITE_ENDIAN_HEADER
  ...
  #define VM_TO_HOST16(instruction) (instruction)
  ...
  #define VM_TO_HOST64(instruction) (instruction)
    ...
    #define VM_TO_HOST16(instruction) __builtin_bswap16(instruction)
...
#define HOST_TO_VM16(instruction) VM_TO_HOST16(instruction)
