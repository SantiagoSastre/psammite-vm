...
{
    if (address + 8 > vm->_memory_size || address + 8 < address)
...
{
    if (address + 4 > vm->_memory_size || address + 4 < address)
        return VM_ERROR_MEM_BOUNDS;
...
{
    if (address + 2 > vm->_memory_size || address + 2 < address)
        return VM_ERROR_MEM_BOUNDS;
...
{
    if (address + 1 > vm->_memory_size || address + 1 < address)
        return VM_ERROR_MEM_BOUNDS;
